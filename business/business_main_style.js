...
const secondCts = document.querySelectorAll(".second-constents");
...
secondQ.addEventListener("click", () => {
  if (secondCts.classList.contains("on")) {
    console.log("클릭");
    for(var i in secondCts){
      secondCts[i].style.display = "none";
      secondCts[i].classList.add("on");
    }
    secondQ.style.color = "black";
...
//<% let now = new Date(); {%>
// <% if(data2.end < now.toLocaleDateString()){%>
//   <div class="funding-done-done">
//     <label class="funding-done-font">펀딩완료</label>
//   </div>
// <% } %>